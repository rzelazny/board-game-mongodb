        ...
        for (const choice of choices) {
            ...
            switch (choice.building) {
                ...
                case "Statue": //may reroll the chosen die
                    ...
                    myDice = player.dice.splice(1, choice.data, newDie); //remove the chosen die and replace with the new die
                    mongo.updatePlayer({ player: playerData._id, field: "dice", data: myDice }, blank);
                ...
                case "Inn": // give a 2token
                    mongo.updatePlayer({ player: playerData._id, field: "twoToken", data: player.twoToken + 1 }, blank);
                    break;
