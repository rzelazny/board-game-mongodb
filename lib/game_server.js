    ...
    gameData.players.forEach(player => {
        ...
        if (player.constructedBuildings.some(e => e.name === "Statue").length > 0) {
            ...
            if (player.dice[0] === player.dice[1] && player.dice[1] === player.dice[2]) {
                playerCanUseBuilding(player, "Statue", canUseBuilding);
        ...
        //if (player.constructedBuildings.some(e => e.name === "Chapel").length > 0) {
            ...
            //if (diceSum < 8 && player.dice.length > 2) {
                playerCanUseBuilding(player, "Chapel", canUseBuilding); //can always use chapel for testing purposes
            //}
       // }
...
function playerCanUseBuilding(player, building, canUseArray){
    ...
    if(objIndex === -1){
        ...
        let playerObj = {player:player._id, building:[building]}
