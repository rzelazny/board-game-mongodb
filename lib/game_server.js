    ...
    gameData.players.forEach(player => {
        ...
        hasMarket.forEach(player => {
            if(player.dice[0] === player.dice[1] && player.dice[1] === player.dice[2]){
                promptUser(player, "building-prompt", "Would you like to use your Statue?");
            }
        })
        ...
        hasMarket.forEach(player => {
            ...
            if(diceSum < 8){
                promptUser(player, "building-prompt", "Would you like to use your Market?");
            }
        })
    });
