...
function imgToResource(advData, player, choice){
    console.log("img2res", advData);
    
    let advChoice = choice.split("-")[0];
    let option = advData.choice[advChoice].optNum;
    let res = "";
    let resNum = 0;
    
    switch(option){
        case 1:
            res = advData.choice[advChoice].option1
            break;
        case 2:
            res = advData.choice[advChoice].option2
            break;
        case 3:
            res = advData.choice[advChoice].option3
            break;
        default:
